...
write.csv(fore.model_NN, file="forecast4 NNDeep.csv")
...
write.csv(akurasi, file="akurasi 4 NNDeep.csv")
...
#MEMBERI NAMA LEGEND#
legend("topleft",c("Data aktual","Neuron 1","Neuron 2","Neuron 3","Neuron 4","Neuron 5"),
       col=c("black",warna),
       lwd=2,cex=0.5)
...
axis(side=2,lwd=0.5,cex.axis=0.8,las=2)
axis(side=1,lwd=0.5,cex.axis=0.8,las=0,at=c(1,seq(35,400,35)))
lines(as.ts(fits.model_NN[,5]),col="red2",lwd=2)
legend("topleft",c("Data aktual","Data ramalan"),
       col=c("black","red2"),lwd=2,cex=0.7)
